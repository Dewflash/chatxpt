...
- Added fixture tests for mixed chat/reaction/vote aggregation, low-confidence unknown handling, rolling-window expiry, session reset, and provenance/evidence class preservation.
