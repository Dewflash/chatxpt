...
- **Verification:** Focused Role 4/server suite (3 files / 18 tests); exact 1440 px and 390 px fixture-browser inspection with five metrics, two recent outcomes, and zero horizontal overflow; full `npm run check` (81 files / 634 tests plus lint, TypeScript, boundaries, evidence/runbook validation, production build, and secret scans); and `git diff --check`.
