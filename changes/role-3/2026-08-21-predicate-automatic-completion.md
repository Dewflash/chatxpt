...
- **Verification:** After synchronizing current main, focused Core, AI-producer, quest-engine, orchestrator, persistence, and Supabase-adapter fixtures passed 10 files / 217 tests. `npm.cmd run check` passed lint, typecheck, boundaries, hygiene, evidence/runbook/secret gates, 90 files / 726 tests, and the production build.
