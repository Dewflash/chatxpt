...
- **Role:** Role 1
- **Issue/PR:** pending
- **Summary:** Every new quest proposal now receives a fresh authoritative cycle identity, so a returning hosted-board viewer can vote again without colliding with their accepted receipt from the preceding quest.
