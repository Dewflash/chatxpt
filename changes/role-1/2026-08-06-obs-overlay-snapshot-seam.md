...
- Verified grant issuance, overlay-only permission scope, authorised overlay-only reads, denied read keys, stale revision protection, and route validation with focused integration tests. This is fixture/runtime seam evidence only; real OBS Browser Source rendering and live overlay proof remain unverified.
