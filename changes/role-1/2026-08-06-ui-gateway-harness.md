...
- Added a repeatable `npm run verify:ui-harness` script that resets the fixture gateway, exercises viewer voting and overlay navigation, and writes a screenshot to `/private/tmp/chatxpt-ui-harness.png`.
