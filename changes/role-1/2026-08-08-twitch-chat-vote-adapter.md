...
- Added bounded poll-open, result, and acknowledgement message templates plus focused tests for strict parsing, verified viewer identity, deterministic duplicate delivery IDs, canonical command/event validation, and safe chat copy.
