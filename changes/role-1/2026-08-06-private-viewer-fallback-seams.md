...
- Verified two-viewer private recovery, cross-surface duplicate vote recovery, hosted access grants, and chat acknowledgement overclaim protection with focused integration tests and `npm run check`.
