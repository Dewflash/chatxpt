...
- **Summary:** Add guided Role 4/5 execution with pass-specific design coaching, non-exhaustive example gates, role-owned decision/pass records, corrected P0/P1 queues, and a complete Role 1 backlog for missing UI integration seams.
