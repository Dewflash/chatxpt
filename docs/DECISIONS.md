...
| D-003 | Accepted | Keep deterministic generation as a permanent fallback. | Protects the demo from credentials, latency, quotas, and outages. | 2026-08-03 — team confirmation via Codex task |
...
| D-005 | Accepted | Require producer approval before activating a quest. | Gives a clear human review and safety boundary. | 2026-08-03 — team confirmation via Codex task |
