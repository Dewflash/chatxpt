...
| P-005 | P0 | READY | Roles 2 and 3 | Public AI and quest-engine ports produce three validated, capability-aware game-neutral candidates. | P-003 | Producer/consumer contract tests, representative evaluations, D-055 no-provider MVP decision, real call path, and deterministic fallback. |
