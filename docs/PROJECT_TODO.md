...
| P-003 | P0 | READY | Role 1 | Version-one public contracts, orchestrator skeleton, capability model, and canonical tests are frozen for the first integration slice. | P-001 plus owner review | Envelopes, ports, commands, view models, errors, revisions, valid/invalid examples, and producer/consumer tests cover all five roles. |
