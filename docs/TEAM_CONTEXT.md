...
| Role 2 audience intelligence policy | `joelyrk` | `role-2/audience-intelligence-policy`; [PR #111](https://github.com/Dewflash/chatxpt/pull/111) | Implement the resolved D2-12 through D2-15 aggregation, privacy, ambiguity, and evidence-separation rules before accepting the audience pipeline | In progress |
