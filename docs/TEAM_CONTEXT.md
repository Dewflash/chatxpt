...
| Live Director product discovery | `Dewflash`; Roles 2/3/4/5 review context | `role-1/finals-isolated-passes`; P-015/R1-022; D-074 | Validate the accepted private Studio/Live Config, public OBS, and individual Extension allocation; then keep, defer, or reject explicit intent, Chat Pointers, Director Cues, the four-state viewer companion, Session Briefs, and a private cue channel through quantitative and qualitative secondary research | In progress; draft implementation plan logged, source activation still evidence-gated |
