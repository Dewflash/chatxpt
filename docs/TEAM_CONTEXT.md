...
| Live Director product discovery | `Dewflash`; Roles 2/3/4/5 review context | `role-1/finals-isolated-passes`; P-015/R1-022; D-074; `docs/research/LIVE-DIRECTOR-SECONDARY-RESEARCH.md` | Accept, modify, or reject the completed research recommendation: retain the narrow audience-to-sidequest loop, experiment with Catch-up/Session Brief, and remove occupied generic cohost/chat/analytics/coaching/native-HUD scope before activating passes | Needs review; secondary research and falsification matrix complete, project-owner scope acceptance pending, no source activation |
