...
| Live Director product discovery | `Dewflash`; Roles 2/4/5 review context | `role-1/finals-isolated-passes`; P-015/R1-022 | Validate explicit streamer intent, source-labelled Live Context, private Director Cues, viewer Catch-up Cards, sidequest activation, Session Briefs, and the in-game private cue channel through secondary research before implementation planning | Planned; evidence gate only |
