...
| Canonical contract implementation | `Dewflash` | `role-1/canonical-contracts` | Versioned schemas, public ports, explicitly non-live fixtures, and schema tests | In progress |
