...
| Role 2 real-input evidence | `joelyrk` | [draft PR #72](https://github.com/Dewflash/chatxpt/pull/72); Role 1 dependency `role-1/obs-capture-spine`; OCR dependency [issue #70](https://github.com/Dewflash/chatxpt/issues/70) | Record two authorised gameplay samples, quiet/action/transition and selective-OCR measurements, latency/resource observations, sanitised chat, and honest unknown behaviour without persisting raw frames | In progress |
