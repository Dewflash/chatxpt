...
| AI input/output contract hardening | `joelyrk`; Role 1/3 shared-seam notification | `role-2/ai-io-contract-fixes` | Carry the current known streamer goal and active quest through candidate generation for every game, reject duplicate citations, and classify OpenAI refusal output correctly | Needs review; source, focused fixture/integration tests, and the full repository check pass, while live provider evidence remains open |
