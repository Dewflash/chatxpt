...
| Role dependency guard and legacy inventory | `Dewflash` | `role-1/boundary-guard` | Enforce public-only cross-role imports and map legacy seams without deciding migration outcomes | In progress |
