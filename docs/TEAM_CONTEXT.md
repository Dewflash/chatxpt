...
| Foundation checkpoint audit | `Dewflash` | `role-1/foundation-audit` | Compile changelog, verify merged main, and publish truthful role-by-role pickup state | In progress |
