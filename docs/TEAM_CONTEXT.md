...
| Role 2 visual extraction spike | `joelyrk` | [PR #55](https://github.com/Dewflash/chatxpt/pull/55); merged browser source [PR #102](https://github.com/Dewflash/chatxpt/pull/102) | Consume the canonical ephemeral `FrameSource` through downsampled visual measurements and selective-region OCR plumbing; record fixture-only evidence until authorised gameplay and a browser-delivered OBS frame are available | Done |
| Role 2 audience intelligence policy | `joelyrk` | [PR #111](https://github.com/Dewflash/chatxpt/pull/111); [PR #118](https://github.com/Dewflash/chatxpt/pull/118) | Apply the resolved D2-12 through D2-15 aggregation, privacy, ambiguity, and evidence-separation rules in the audience pipeline | Done |
| Role 2 real-input evidence | `joelyrk` | [draft PR #72](https://github.com/Dewflash/chatxpt/pull/72); merged browser source [PR #102](https://github.com/Dewflash/chatxpt/pull/102); OCR dependency [issue #70](https://github.com/Dewflash/chatxpt/issues/70) / [PR #75](https://github.com/Dewflash/chatxpt/pull/75) | Record two authorised gameplay samples, quiet/action/transition and selective-OCR measurements, latency/resource observations, sanitised chat, and honest unknown behaviour without persisting raw frames | In progress |
