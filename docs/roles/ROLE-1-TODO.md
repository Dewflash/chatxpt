...
| R1-016 | P0 | IN PROGRESS | Implement private per-viewer recovery plus hosted-board discovery and Twitch-chat delivery seams. | R1-003/R1-004; UI-X07/UI-X08/UI-X10; D1-06D/D1-06E | Contract schemas and memory fallback now cover private viewer recovery, sanitised shared broadcasts, hosted-board room-code discovery, and explicit chat-vote acknowledgement statuses on `codex/role-1-viewer-recovery-seams`; Supabase/cloud and real Twitch chat adapter evidence remain separate. |
