...
| R1-003 | P0 | READY | Freeze version 1 contracts, public ports, orchestrator skeleton, and capability model. | R1-001; input from Roles 2-5 | Canonical envelopes/view models/commands/errors and valid/invalid examples exist; producer/consumer tests run without direct cross-role imports. |
