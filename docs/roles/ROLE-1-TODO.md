...
| R1-002 | P0 | BLOCKED | Perform the one-time public-entry ownership migration. | R1-003 skeleton | Files move behind public entry points into recorded ownership boundaries with behaviour/checks preserved; thin Role 1 routes mount UI modules. |
