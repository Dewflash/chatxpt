...
| R2-009 | P0 | READY | Produce the AI/data integration build plan for Roles 4 and 5. | Current prototype; D-016 | One plan defines available data, confidence/source metadata, loading/failure/fallback states, fixtures, and contract proposals; it identifies UI decisions that remain with each UI owner. |
