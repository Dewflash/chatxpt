...
| R3-002 | P0 | BLOCKED | Implement deterministic quest lifecycle and transitions. | Shared contracts | Tests cover proposed, voting, active, succeeded, failed, cancelled, skipped, and expired. |
