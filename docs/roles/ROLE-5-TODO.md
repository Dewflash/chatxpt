...
| R5-007A | P0 | IN PROGRESS | Build basic reactions, community hype, private session points, and reconnect presentation. | Participation/reward contracts; Role 1 authorised reaction dispatcher and personalised-viewer seam | The board now displays server-supplied community hype/session XP and enables reactions only when an authorised dispatcher is provided; private recovery and real-service evidence remain pending. |
