...
Role 1 owns this directory. It contains platform-neutral runtime contracts and, in later passes, the application orchestrator. Twitch, OBS, provider, persistence, and component-local UI payloads terminate at adapters outside this directory.
