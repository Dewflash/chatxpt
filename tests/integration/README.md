...
finality across participation sources and deadline-bounded tally reads. It still
does not claim that migrations, RLS, or WebSockets ran against a real database.
